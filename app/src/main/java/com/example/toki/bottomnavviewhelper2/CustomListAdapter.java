    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        try{
            ...
            if(convertView == null){
                ...
                holder.dailog = (ProgressBar) convertView.findViewById(R.id.cardProgressDialog);
            ...
            imageLoader.displayImage(imgUrl, holder.image, options, new ImageLoadingListener() {
                ...
                public void onLoadingStarted(String imageUri, View view) {
                    holder.dailog.setVisibility(View.VISIBLE);

                }
                @Override
                public void onLoadingFailed(String imageUri, View view, FailReason failReason) {
                    holder.dailog.setVisibility(View.GONE);
                }
                @Override
